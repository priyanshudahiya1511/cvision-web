...
import { googleAuthService, registerService } from "@/services/auth.service";
      ...
      <Card className="w-full max-w-md flex flex-col">
        ...
        <CardContent className="bg-card rounded-xl">
          ...
          >
            ...
            <p className="text-[1.1rem]">Sign up with Google</p>
          </Button>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="space-y-1.5 flex-col">
              <Label htmlFor="name" className="ml-1 text-[1.1rem]">
                Full Name
              </Label>
              <Input
                id="name"
            ...
            <div className="space-y-1.5 flex-col">
              <Label htmlFor="password" className="ml-1 text-[1.1rem]">
                Password
              </Label>
            ...
            >
              {isLoading ? (
                ...
                <p className="text-[1.1rem] text-white">Create account</p>
              )}
            </Button>
